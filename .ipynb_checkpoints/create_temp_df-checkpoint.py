...
available_regions = [HPC_labels, ENT_labels, PHC_labels, temporal_lobe_labels, MFG_labels, IFG_labels,
                     nonHPC_MTL_labels, ENTPHC_labels, AMY_labels]
...
def create_temp_df_func(df, exp, save_path, selected_period, recall_type_switch, 
    ...
    with open(f'/home1/efeghhi/cluster/temp_dfSWR_{region_name}_{selected_period}_{exp}.p', 'wb') as f: 
